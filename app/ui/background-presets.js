...
if(!runtime){window.addEventListener('load',()=>{const s=document.createElement('script');s.src='./app/ui/web-threads.js?v=20260904-11';s.async=false;document.body.appendChild(s);const bridge=document.createElement('script');bridge.textContent='window.state = state;';document.body.appendChild(bridge);const runtimeScript=document.createElement('script');runtimeScript.src='./app/ui/background-presets.js?v=20260904-11&runtime=1';runtimeScript.async=false;document.body.appendChild(runtimeScript)},{once:true});return}
...
if(!document.querySelector('.kefe-landing-home')&&window.KefeWebThreads){
  ...
  requestAnimationFrame(()=>threads.refresh());
