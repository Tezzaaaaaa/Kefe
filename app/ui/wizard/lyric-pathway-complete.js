...
(() => {
  ...
  const STYLE_COPY = {
    ...
    drop: ['Drop', 'Lyrics fall into position'], drift: ['Drift', 'Gentle horizontal lyric movement'], scrolllines: ['Scroll Lines', 'Lyrics travel through the frame'], vhsglitch: ['VHS Glitch', 'Red channel-split text with scanline tears']
  };
  ...
  function start() {
    const style = document.createElement('style'); style.id = 'kefeFinalLyricPathwayCSS'; style.textContent = `
      ...
      @keyframes kefeStylePulse{50%{transform:scale(1.06)}}@keyframes kefeStyleRise{50%{transform:translateY(-5px)}}@keyframes kefeStyleType{from{max-width:0}to{max-width:100%}}@keyframes kefeStyleBlur{50%{filter:blur(0)}}@keyframes kefeStyleShine{to{background-position:-220% 0}}@keyframes kefeStyleSlide{50%{transform:translateX(6px)}}@keyframes kefeStyleDrop{50%{transform:translateY(6px)}}@keyframes kefeStyleDrift{50%{transform:translateX(8px)}}@keyframes kefeStyleScroll{50%{transform:translateY(-7px)}}@keyframes kefeStyleGlitch{0%,100%{transform:translate(0,0);text-shadow:-2px 0 #20E0FF}50%{transform:translate(-2px,1px);text-shadow:2px 0 #20E0FF}}
