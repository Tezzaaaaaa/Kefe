...
(() => {
  ...
  // Remove UI that belonged to retired product areas.
  ...
  const lyricEffectCopy = {
    apple: 'Focused, polished lyric stack',
    brat: 'Bold kinetic typewriter',
    eternal: 'Handwritten flowing lyric cycle',
    aurora: 'Colour-shifting glow',
    pulse: 'Rhythmic scale and glow',
    typewriter: 'Character-by-character reveal',
    instagram: 'Bold social-style lyric stack',
  ...
  document.addEventListener('change', event => {
    if (steps[index].id === 'source' || steps[index].id === 'lyrics') {
      next.disabled = !valid(steps[index]);
    }
    if (steps[index].id === 'style' && event.target.closest('#lyricStyleBlock')) {
      syncLyricEffects();
    }
  }, true);
