...
(() => {
    ...
    if (!document.querySelector('link[data-kefe-wizard-style-preview]')) { const styleLink = document.createElement('link'); styleLink.rel = 'stylesheet'; styleLink.href = './wizard-style-preview.css'; styleLink.dataset.kefeWizardStylePreview = 'true'; document.head.appendChild(styleLink); }
