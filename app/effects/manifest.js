/* KEFE — the one place effect names live.
 * Add a new lyric effect here, plus a <script> tag for its renderer
 * file in index.html. Nothing else needs editing — the picker, the
